...
const plainCount = (TSX.match(/className="cs-pop-body"/g) || []).length;
ok('11~13. 미처리/처리완료/AI함 3개 팝업에 .wide 적용', wideCount === 2 /* CsItemPopup(미처리·AI함 공유) + CsResolvedPopup */ && plainCount === 1 /* 고객관리 */);
ok('14. 고객관리 팝업은 기본 비율 유지(.wide 아님) + 구조 불변', plainCount === 1 && /CsCustomerPopup/.test(TSX) && /블랙리스트 후보/.test(TSX));
