...
**수치 재계산(표에서 직접 셈)**: 공식 출처 21 → **28** · 확정 사실 20 → **27** · 조건부 사실 3 → **4** · 미확인 21 → **17개**(개별 7 + 회사 서버 확인표 10).

**여전히 미확인 (7 + 10)**: 무료 프로젝트 자동 삭제 규정(양쪽) · Neon 백업 방식(물리/논리) · Neon **계약적 데이터 레지던시 약정**(*배치 지역 선택 가능은 확정*) · Neon Object Storage **GA 가격·확정 한도**(공급자 미공개) · Neon 실시간 반영 수단 · **무료 등급 적합 여부**(우리 사용량 부재) · **Neon 직접 연결 상한 실제 값**(우리 프로젝트 부재) · 회사 서버 확인표 10항목.
