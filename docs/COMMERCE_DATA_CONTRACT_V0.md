...
> **갱신(Activation v0)**: 이후 synthetic 기본 source가 godoRaw → **commerce_universe_v1**로 다시 승격됨. godoRaw/legacy는 명시 옵션 유지. `docs/SYNTHETIC_COMMERCE_UNIVERSE_ACTIVATION_V0.md`.
